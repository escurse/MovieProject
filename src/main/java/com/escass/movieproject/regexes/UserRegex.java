package com.escass.movieproject.regexes;
...
public class UserRegex {
    ...
    public static boolean checkEmail(UserEntity user) {
        return user != null && checkEmail(user.getUsEmail());
    }
    ...
    public static boolean checkPassword(UserEntity user) {
        return user != null && checkPassword(user.getUsPw());
    }
    ...
    public static boolean checkNickname(UserEntity user) {
        return user != null && checkNickname(user.getUsNickName());
    }
}